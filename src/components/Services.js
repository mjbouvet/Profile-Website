    ...
    <div class="services">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="box">
                        <div class="circle"><FontAwesomeIcon className="icon" icon={faFacebookF} size="2x"/></div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="box">
                    <div class="circle"><FontAwesomeIcon className="icon" icon={faGoogle} size="2x"/></div>
                        <h3>Google Ads</h3>
